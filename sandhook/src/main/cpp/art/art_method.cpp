...
// Begin Dreamland added: addAccessFlags() and removeAccessFlags()
void ArtMethod::addAccessFlags(uint32_t flags) {
    setAccessFlags(getAccessFlags() | flags);
}

void ArtMethod::removeAccessFlags(uint32_t flags) {
    setAccessFlags(getAccessFlags() & ~flags);
}

// End Dreamland added: addAccessFlags() and removeAccessFlags()
