...
public abstract class XCallback implements Comparable<XCallback> {
	 ...
	 */
	// Dreamland changed: XCallback.Param is Cloneable
	public static abstract class Param implements Cloneable {
		/** @hide */
		...
		// Dreamland changed: clone support
		@Override public XCallback.Param clone() {
			try {
